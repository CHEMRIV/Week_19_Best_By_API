...
import ui.swagger.model.ProductsPojo;
...
public class ProductsStep {
    ...
    public ValidatableResponse updatingProduct(int productID, String name, String type,
                                               int price, int shipping, String upc,
    ...
    public ValidatableResponse getAllProductListInfo() {
        return SerenityRest.given().log().all()
                .when()
